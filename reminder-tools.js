(function (root, factory) {
  ...
  return {
    ...
    SNOOZE_MINUTE_VALUES: SNOOZE_MINUTE_VALUES,
    normalizeReminderMinutes: normalizeReminderMinutes,
    calculateReminderAt: calculateReminderAt,
    normalizeSnoozedUntil: normalizeSnoozedUntil,
    calculateSnoozedUntil: calculateSnoozedUntil,
    getPlanReminderAt: getPlanReminderAt,
