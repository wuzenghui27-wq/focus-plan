(function (root, factory) {
  ...
  return {
    DAILY_GOAL_STORAGE_KEY: DAILY_GOAL_STORAGE_KEY,
    DEFAULT_DAILY_GOAL_MINUTES: DEFAULT_DAILY_GOAL_MINUTES,
    MIN_DAILY_GOAL_MINUTES: MIN_DAILY_GOAL_MINUTES,
    MAX_DAILY_GOAL_MINUTES: MAX_DAILY_GOAL_MINUTES,
    getValidDailyGoalMinutes: getValidDailyGoalMinutes,
    loadDailyGoal: loadDailyGoal,
    saveDailyGoal: saveDailyGoal,
    calculateDailyGoalProgress: calculateDailyGoalProgress,
    calculateDailyGoalStreak: calculateDailyGoalStreak
  };
});
