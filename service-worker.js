const CACHE_NAME = "focus-plan-shell-v27";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./styles/app.css",
  "./styles/controls.css",
  "./styles/dark-refinements.css",
  "./styles/dialog-refinements.css",
  "./styles/features.css",
  "./styles/focus-refinements.css",
  "./styles/foundation.css",
  "./styles/history-refinements.css",
  "./styles/layout.css",
  "./styles/mobile-refinements.css",
  "./styles/plan-refinements.css",
  "./styles/responsive.css",
  "./styles/settings-refinements.css",
  "./styles/shell-refinements.css",
  "./styles/theme.css",
  "./styles/tokens.css",
  "./src/client/app.js",
  ...
  "./src/client/services/sync-api.js",
